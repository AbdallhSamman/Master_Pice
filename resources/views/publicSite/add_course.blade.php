...
<section  style=" padding-top:200px;">
    <div class="container">
        <h2  style="font-family:Arial, Helvetica, sans-serif;">Add a New Course</h2>
        <ul class="thm-breadcrumb list-unstyled s" >
            <li style="color: #000"><a href="{{ route("home2")}}">Home</a></li>
            <li style="color: #000"><span>Add Course</span></li>
        </ul>
    </div>
</section>
                ...
                <div class="col-md-12">
                    <div class="col-lg-12">
                        <div class="card trip-form">
                            <div class="card-header" style="font-size: 20px">Add Course</div>
                            <div class="card-body card-block">
                                <form action="{{route('guideTrip.store')}}" method="POST" enctype="multipart/form-data" class="create-trip-form">
                                    ...
                                    <div class="form-group">
                                        <input type="file" id="video" name="video" value="{{old('video')}}" class="form-control">
                                    </div>
                                    <div class="form-actions form-group">
                                        <button type="submit" class="btn btn-secondary btn-sm">Update course details</button>
                                    </div>
                                </form>
                            </div>
                        </div>
