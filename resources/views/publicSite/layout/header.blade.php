...
<body>
    ...
    <div class="page-wrapper">
        <div class="site-header__header-one site-header__home-two-wrap" >
            ...
            <header class="main-nav__header-one site-header__home-two" style="background-color:#501a18;height: 120px;" >
                {{-- <nav class="header-navigation stricky "> --}}
                    <div class="container"  >
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="main-nav__logo-box" style="margin-left: 50px;">
                            <a href="{{ route('home2') }}" class="main-nav__logo">
                                <img src={{asset("assets/images/loader.png")}} class="main-logo" width="80" alt="Awesome Image" />
                            </a>
                        ...
                        <div class="main-nav__main-navigation">
                            <ul class=" main-nav__navigation-box">
                                ...
                                <li>
                                    <a href="{{route('guideTrip.create', Auth::user()->id)}}">Add a Course</a>
                                </li>
                                @endif
                                @endauth
                            </ul>
